...
const ELEMENTS: Record<string, ElementData> = {
  ...
  LITHIUM: { name: "Lithium", color: "#d3d3d3", flameColors: ["#ff0055", "#ee0033", "#ff4477"], sparks: { enabled: false }, duration: 3000 },
  SODIUM: { name: "Sodium", color: "#e0e0e0", flameColors: ["#ffdd00", "#ffcc00", "#ffee33"], sparks: { enabled: true, color: "#ffff55", count: 40 }, duration: 4000 },
  POTASSIUM: { name: "Potassium", color: "#cccccc", flameColors: ["#d000ff", "#c000ee", "#e044ff"], sparks: { enabled: false }, duration: 2500 },
};
